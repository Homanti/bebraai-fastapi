...
- 📷 Поддержка R2-хранилища для изображений — не забудьте настроить .env или отключите R2 в коде.
...
- **[g4f](https://github.com/xtekky/gpt4free)** — библиотека для использование API OpenAI и других
